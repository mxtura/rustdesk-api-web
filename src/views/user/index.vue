<template>
  <div>
    ...
    <el-card class="list-body" shadow="hover">
      ...
      <!-- ПЛИТКИ -->
      <div v-if="viewMode === 'cards'" v-loading="listRes.loading" class="user-grid">
        <div v-for="row in listRes.list" :key="row.id" class="user-card">
          ...
          <div class="uc-specs">
            <div class="spec" :title="row.email">
              <el-icon><Message /></el-icon><span>{{ row.email || '—' }}</span>
            </div>
            <div class="spec">
              <el-icon><Calendar /></el-icon><span>{{ row.created_at }}</span>
            </div>
            <div v-if="row.remark" class="spec spec-full" :title="row.remark">
              <el-icon><Document /></el-icon><span>{{ row.remark }}</span>
            </div>
          </div>

          <div class="uc-actions">
            <el-button type="primary" class="uc-book" :icon="Notebook" @click="toAddressBook(row)">{{
              T('AddressBook')
            }}</el-button>
      ...
      <!-- ТАБЛИЦА -->
      <el-table v-else v-loading="listRes.loading" :data="listRes.list" border>
